...
Категориальные признаки были закодированы вручную. Также была протестирована встроенная обработка категориальных признаков в модели CatBoost, однако ручное кодирование показало более стабильное качество.
#### Текстовые признаки
...
#### Числовые признаки
Числовые признаки логарифмировались. При необходимости применялась стандартизация.
#### Изображения
